 ...
 * team
 * 
 * @author Simon Date: July 17, 2015
 */
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		// add markers for the earthquakes from the parser and to style each of
		// them
		...
		// display the markers for the Unfolding map
	...
	private SimplePointMarker createMarker(PointFeature feature) {
	  // integers that represent the colors.
	  int yellow = color(255, 255, 0);
      int red = color(249, 0, 0);
      int blue = color(34, 0, 255);

      // floats that represent the radius of markers
      float small = 6;
      float medium = 10;
      float largest = 16;

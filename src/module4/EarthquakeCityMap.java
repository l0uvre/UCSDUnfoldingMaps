...
public class EarthquakeCityMap extends PApplet {
  ...
  public void setup() {
    ...
    if (offline) {
      ...
      earthquakesURL = "2.5_week.atom"; // The same feed, but saved August 7,
                                        // 2015
    } else {
  ...
  private void printQuakes() {
    ...
    for (Marker country : countryMarkers) {
      ...
      if (earthcount > 0) {
        System.out.printf("The number of earthquakes detected in %s is %d.\n", country.getStringProperty("name"), earthcount);
      }
      earthcount = 0;
    } // print the numbers from countries' earthquakes respectively
    ...
    System.out.printf("The number of earthquakes detected the ocean is %d.\n", occeanCount);
  }// print the numbers of the ocean earthquakes.
